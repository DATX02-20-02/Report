...
CityCraft's GUI follows the \textit{Wizard} design pattern to guide its users through the generation process, which is split into four steps (see Figure \ref{fig:guisteps}).
