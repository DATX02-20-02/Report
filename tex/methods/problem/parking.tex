...
This would have been a viable option for this project, but it was found that it offers little alternatives for modification.
...
By using a single mesh with one texture applied to it, it would remove the possibility of scaling the size of the parking spaces within the mesh without scaling the mesh itself, which was not an option.
