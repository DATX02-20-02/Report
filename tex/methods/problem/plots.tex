...
This separation of concern leads to greater modularity and makes it easier mix a large variety of different plot labels within a single block.
...
An article about splitting polygons was found that explained how to split a polygon into $N$ parts, where each part would have equal size \cite{polygon_splitting_article}. 
...
% We use shortest length though..? Should be mentioned.
