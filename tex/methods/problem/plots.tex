...
An article about splitting polygons was found that explained how to cut a polygon into $N$ parts, where each piece would have equal size \cite{polygon_splitting_article}. 
