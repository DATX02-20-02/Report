...
Furthermore, strategies may instruct the Agent to switch strategy mid-generation, be it randomly, or to depend on some variables that the strategy has access to.
