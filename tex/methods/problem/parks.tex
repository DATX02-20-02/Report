...
This final change was made to stop enforcing loops and to add more variety to the generated paths.
...
The final implementation would instead make use of the RoadGenerator's spline logic to create the paths.
This was done by simply replacing the existing road texture with a more natural one (see Figure~\ref{fig:visuals}).
\begin{figure}[H]
  \centering
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    \frame{\includegraphics[width=\textwidth]{figure/scr}}
