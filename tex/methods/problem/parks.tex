...
Here the object-radius is used in order to determine how close objects may stack. 
...
This was changed in order to try to get rid of the linearity presented in the first implementation.
