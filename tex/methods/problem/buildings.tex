...
\begin{figure}[H]
  ...
  \end{lstlisting}
  \caption{Detailed implementation of wall segment generation via the implemented L-system in CityCraft. This structure gives the developers freedom to customize generation to their choosing. Notice how the \textit{Wall} segment types have a 50\% chance of the next segment being another \textit{Wall}, or a \textit{Window}.}
