...
\begin{table}[H]
  ...
  \caption[]{The proposed generator functions needed to generate the 3D cities. The invocation of these functions are handled by WorldGenerator. '\textit{[]}' denotes plural (e.g. list or array) of the preceeding data structure.}
