...
First, a user interface would be necessary for users to be able to control and see any generation -- preferably a GUI (Graphical User Interface) since user-friendliness was a key requirement.
