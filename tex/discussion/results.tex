...
Accessing and creating a junction in the previously generated road network introduces new data that intermediate generation steps has not previously considered.
...
Furthermore, the steps necessary to generate a city follows an easy step-by-step Wizard~\cite{yer_a_wizard} that is familiar to most users.
