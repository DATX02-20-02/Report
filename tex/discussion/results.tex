...
This structural resemblance is demonstrated in Figure~\ref{fig:results_real_city_manhattan} and \ref{fig:results_real_city_paris}.
...
To our knowledge, however, no real-world city exists that disregards human convenience to the same degree as CityCraft.
Therefore, the project group does not consider the cities generated by CityCraft to be believable by real-world standards.
