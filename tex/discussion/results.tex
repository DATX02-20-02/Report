...
Accessing and creating a junction in the previously generated road network however, introduces new information that intermediate generation steps hasn't previously considered.
...
The variety in skyscrapers, buildings, and roads are limited though.
...
Furthermore, the steps necessary to generate a city follows an easy step-by-step Wizard~\cite{yer_a_wizard} that's familiar to most users.
Admittedly, the application has not undergone any formal user testing to verify this.
One area of usability improvements would be to improve the design and pliancy of the user interface to provide better feedback.
