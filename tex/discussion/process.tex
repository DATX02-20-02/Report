...
Typically, different distance intervals are configured to correspond to meshes with different qualities.
...
The first version had a mesh for each wall segment, and each wall segment had material with an accompanying texture. 
This leads to memory usage peaking over $10$GB with a medium-sized city. 
